 ...
 */
var CACHE_VERSION = "family-projekt-v119";
...
var VORRAT_PRAEFIX = "family-projekt-";
...
var CORE = [
  ...
  "assets/style.css?v=119", "assets/app.js?v=119", "assets/notranslate.js?v=119", "assets/status-widget.js?v=119",
  ...
  // ohne Netz zum Schulen und Drucken braucht.
  "werkzeuge/ki-schulung.html", "schulung/EU_AI_Act_Art4_KI_Schulung.html"
];
...
self.addEventListener("activate", function (e) {
  e.waitUntil(
    caches.keys().then(function (keys) {
      return Promise.all(keys.filter(function (k) { return k.startsWith(VORRAT_PRAEFIX) && k !== CACHE_VERSION; })

...
window.FP_WERKZEUGE = [
  { id: "box", name: "Mycel-Geschenkbox", icon: "🎁",
    ...
    de: "Alle SBKIM-Bausteine, fertig zum Auspacken: Verbinden, Siegel, Schutz, Andock-Wizard, Safe, Suche. Vier Wege, sie zu holen, nach Können sortiert. Vom KI-Einbau bis zum Ein-Befehl-Installer.",
    en: "All SBKIM blocks, ready to unpack: connect, seal, protection, docking wizard, safe, search. Four routes to get it, sorted by skill. From AI install to a one-command installer.",

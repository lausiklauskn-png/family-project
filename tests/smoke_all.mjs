...
{ const { page } = await load("/index.html");
  ...
  ok(await dev.evaluate(()=>!!document.getElementById("fp-dev-announce")&&!!document.getElementById("fp-dev-discover")&&!!window.SbkimNostrRelay&&typeof SbkimNostrRelay.publish==="function"&&typeof SbkimNostrRelay.subscribe==="function"), "Andock-Tool ⑥: Gemeinsamer-Raum-Knöpfe (Auffindbar/Wer-ist-im-Raum) + Relais-Publish/Subscribe verfügbar");
